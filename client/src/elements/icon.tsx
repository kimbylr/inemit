...
const icons = {
  ...
  sync: (width?: string) => (
    <svg viewBox="11.9 13 24 24" width={width || '100%'}>
  ...
  import: (width?: string) => (
    <svg viewBox="0 0 24 24" width={width || '100%'} fill="currentColor">
  ...
  logo: (width?: string) => (
    <svg viewBox="0 0 390 298" fill="currentColor" width={width || '100%'}>
  ...
  image: (width?: string) => (
    <svg viewBox="6 12 54 40" fill="currentColor" width={width || '100%'}>
  ...
  iOSShare: (width?: string) => (
    <svg viewBox="0 0 566 670" width={width || '100%'}>
  ...
  iOSHomescreen: (width?: string) => (
    <svg viewBox="0 0 578 584" width={width || '100%'}>
  ...
  more: (width?: string) => (
    <svg width={width || '100%'} viewBox="0 0 122.88 122.88" stroke="currentColor">
  ...
  settings: (width?: string) => (
    <svg width={width || '100%'} viewBox="0 0 48 48" fill="currentColor">
